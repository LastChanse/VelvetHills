...
public class LoginController {
    ...
    private void activateLoginField() {
        loginField.setStyle("-fx-background-color: #00000000; -fx-border-color: #92D050; -fx-border-width: 0px 0px 2px 0px;");
    ...
    private void activatePasswordField() {
        ...
        passwordField.setStyle("-fx-background-color: #00000000; -fx-border-color: #92D050; -fx-border-width: 0px 0px 2px 0px;");
        passwordTextField.setStyle("-fx-background-color: #00000000; -fx-border-color: #92D050; -fx-border-width: 0px 0px 2px 0px;");
    }
    ...
    private void selectedAuth() {
        authBtn.setStyle("-fx-background-color: #92D050aa;");
    }

    @FXML
    private void unselectedAuth() {
        authBtn.setStyle("-fx-background-color: #92D050;");
    }
